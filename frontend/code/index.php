<?php
echo "<h1> This is the Three Tier Architecture Test New Mytest, YAY!!!!</h1>";
echo "<h3> Your Web Running Apache with php on Frontend container, YAY </h3>";
...
{
        print "We have trouble in our System we will be back soon. Please have patience";
        die();
}
